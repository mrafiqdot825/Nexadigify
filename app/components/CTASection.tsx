...
export function CTASection({
  ...
  return (
    <section className="relative overflow-hidden bg-[#f7fafc] py-10">
      <div className="relative isolate mx-3 overflow-hidden rounded-[24px] sm:rounded-[32px] border border-[rgba(0,70,150,0.12)] bg-white px-5 py-12 sm:px-8 sm:py-16 md:px-12 md:py-20 shadow-[0_20px_60px_rgba(0,70,150,0.08)] sm:mx-6 md:mx-auto md:max-w-6xl">
        ...
        <ScrollReveal className="relative z-10 mx-auto max-w-2xl text-center">
          ...
          {description && (
            <p className="mx-auto mt-4 sm:mt-5 max-w-xl text-base sm:text-lg leading-relaxed text-[#526575]">
              {description}
            </p>
          )}
          <div className="mt-8 sm:mt-9 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3.5 sm:gap-4 w-full sm:w-auto">
            <Link
              to={primaryTo}
