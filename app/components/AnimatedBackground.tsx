  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,70,150,0.28), transparent 70%)",
          opacity: intensity,
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(30,142,171,0.26), transparent 70%)",
          opacity: intensity,
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,70,150,0.16), transparent 70%)",
