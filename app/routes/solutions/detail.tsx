  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white py-6 sm:py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="overflow-hidden rounded-[20px] sm:rounded-[28px] border border-[rgba(0,70,150,0.12)] bg-[#070912] shadow-[0_24px_54px_rgba(0,70,150,0.14)]">
            <img
          ...
          <ScrollRevealStagger className="mt-10 sm:mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {solution.process.map((p) => (
              <ScrollRevealItem key={p.step}>
                <div className="h-full rounded-[22px] sm:rounded-[24px] border border-[rgba(0,70,150,0.1)] bg-white p-5 sm:p-7">
                  <span className="text-3xl sm:text-4xl font-extrabold text-[rgba(0,70,150,0.15)]">
                    {p.step}
                  </span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-10 sm:gap-14 lg:grid-cols-2 lg:gap-16">
            <SectionHeader
              ...
              highlight="matters."
            />
            <ScrollRevealStagger className="space-y-5 sm:space-y-6">
      ...
      <section className="relative bg-[#f3f8fa] py-14 sm:py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 sm:gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          <ScrollReveal>
            <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#004696] to-[#1e8eab] text-white">
              <Icon size={24} />
            </div>
            <h3 className="mt-5 sm:mt-6 text-xl sm:text-2xl font-bold text-[#0b1f33]">
              Use Cases
            </h3>
