  ...
  return /* @__PURE__ */ jsxs(
    Link,
    {
      ...
      children: [
        ...
        showText && /* @__PURE__ */ jsxs("span", { className: "flex items-center text-xl tracking-tight select-none", children: [
          /* @__PURE__ */ jsx("span", { className: "font-black tracking-[-0.03em] text-[#004696]", children: "NEXA" }),
          /* @__PURE__ */ jsx("span", { className: "ml-1.5 font-medium tracking-[-0.01em] text-[#1e8eab]", children: "DIGIFY" })
        ] })
      ]
    }
  );
...
const stylesheet = "/assets/app-CnR9kHGW.css";
const links = () => [{
  rel: "stylesheet",
  href: stylesheet
}, {
